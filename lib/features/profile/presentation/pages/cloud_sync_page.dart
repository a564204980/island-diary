  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Colors.transparent,
        leading: IconButton(
          icon: Icon(Icons.arrow_back_ios_new_rounded, color: isNight ? Colors.white70 : Colors.black87),
      ...
      body: Stack(
        children: [
          ...
          Positioned.fill(
            child: CustomPaint(
              painter: _TopRightBackgroundPainter(isNight: isNight),
            ),
          ),
          SafeArea(
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            right: 0,
            top: 10,
            child: _CloudIllustrationWidget(isNight: isNight, primaryColor: _primaryColor),
          ),
        ],
      ),
    );
...
class _CloudIllustrationWidget extends StatelessWidget {
  final bool isNight;
  final Color primaryColor;
  const _CloudIllustrationWidget({required this.isNight, required this.primaryColor});
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: 80,
      child: CustomPaint(
        painter: _CloudIllustrationPainter(isNight: isNight, primaryColor: primaryColor),
      ),
    );
  }
}

class _CloudIllustrationPainter extends CustomPainter {
  final bool isNight;
  final Color primaryColor;
  _CloudIllustrationPainter({required this.isNight, required this.primaryColor});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final dashPaint = Paint()
      ..color = isNight ? Colors.white.withOpacity(0.08) : primaryColor.withOpacity(0.25)
    ...
    canvas.drawPath(
      cloudPath,
      Paint()
        ..color = isNight ? Colors.black.withOpacity(0.3) : primaryColor.withOpacity(0.12)
...
class _TopRightBackgroundPainter extends CustomPainter {
  final bool isNight;
  _TopRightBackgroundPainter({required this.isNight});
...
class _BottomDecorationWidget extends StatelessWidget {
  final bool isNight;
  const _BottomDecorationWidget({required this.isNight});
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: 30,
      child: CustomPaint(
        painter: _BottomDecorationPainter(isNight: isNight),
      ),
    );
  }
}
...
class _BottomDecorationPainter extends CustomPainter {
  final bool isNight;
  _BottomDecorationPainter({required this.isNight});
