...
class _MomentsReplySheetState extends State<MomentsReplySheet> {
  ...
  Widget build(BuildContext context) {
    final bgColor = widget.isNight ? const Color(0xFF1A1C1E) : const Color(0xFFFDF9F0);
    final accentColor = const Color(0xFFD4A373); 
    final inkColor = widget.isNight ? Colors.white.withValues(alpha: 0.8) : const Color(0xFF5D4037); 
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              decoration: BoxDecoration(
                color: widget.isNight ? Colors.white.withValues(alpha: 0.07) : Colors.black.withValues(alpha: 0.03),
                borderRadius: BorderRadius.circular(16),
                border: Border.all(
                  color: widget.isNight ? Colors.white.withValues(alpha: 0.12) : const Color(0xFFE8D5B5).withValues(alpha: 0.5),
                  width: 1,
                ),
              ),
...
class MomentsConfirmDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final inkColor = isNight ? Colors.white.withValues(alpha: 0.8) : const Color(0xFF5D4037);
