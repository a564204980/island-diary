...
class DiaryShareCardBuilder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return RepaintBoundary(
      ...
      child: Container(
        ...
        decoration: const BoxDecoration(color: Color(0xFFFDF9F0)),
        child: Column(
  ...
  Widget _buildDayContent() {
    if (entries.isEmpty) {
      return const Center(
        child: Text("这一天没有记录哦", style: TextStyle(fontFamily: 'LXGWWenKai')),
      );
    }
      ...
      children: entries.map((entry) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: const Color(0xFFD4A373).withValues(alpha: 0.1)),
          ),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              RichText(
                text: TextSpan(
                  children: EmojiMapping.parseText(entry.content.trim()).map((
                    chunk,
                  ) {
                    if (chunk.isEmoji) {
                      return WidgetSpan(
    ...
    return Column(
      ...
      children: [
        ...
        Wrap(
          ...
          children: sortedMoods.map((e) {
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                color: (mood.glowColor ?? const Color(0xFFD4A373)).withValues(
                  alpha: 0.1,
                ),
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 13,
                      color: (mood.glowColor ?? const Color(0xFF5D4037))
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: const Color(0xFFD4A373).withValues(alpha: 0.05),
            borderRadius: BorderRadius.circular(16),
          ),
          child: Column(
            children: [
  ...
  Widget _buildBookContent() {
    if (entries.isEmpty) {
      return const Center(
        child: Text("还没有任何记录哦", style: TextStyle(fontFamily: 'LXGWWenKai')),
      );
    }
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  RichText(
                    text: TextSpan(
                      children: EmojiMapping.parseText(entry.content.trim())
                          .map((chunk) {
                            if (chunk.isEmoji) {
                              return WidgetSpan(
                                alignment: PlaceholderAlignment.middle,
        ...
        ...entry.replies
            .map(
              (reply) => Container(
                ...
                decoration: BoxDecoration(
                  color: Color(0xFFD4A373).withValues(alpha: 0.04),
                  borderRadius: BorderRadius.circular(8),
                ),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    RichText(
                      text: TextSpan(
                        children: EmojiMapping.parseText(reply.content.trim())
                            .map((chunk) {
                              if (chunk.isEmoji) {
                                return WidgetSpan(
                                  child: Padding(
