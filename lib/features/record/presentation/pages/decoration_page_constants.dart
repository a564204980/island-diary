...
enum WallPattern { none, stripes, dualColor, lavenderStripes, wainscoting, clouds, gradient, sparkle, meltingDrips, greenHills, vintageFloral, ivySkirting }
enum FloorPattern { none, herringbone, tripleHerringbone, plaid, randomWood, harlequin }
