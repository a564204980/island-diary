...
enum WallPattern { none, stripes, dualColor, lavenderStripes, wainscoting, clouds, gradient, sparkle, meltingDrips, greenHills }
enum FloorPattern { none, herringbone, tripleHerringbone, plaid }
