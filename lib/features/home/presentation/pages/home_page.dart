      ...
      default:
        return Stack(
          ...
          children: [
            ...
            // 云朵层
            Positioned.fill(
              child: FloatingClouds(isNight: isNight, shouldAnimate: _currentNavIndex == 0),
            ),
            // 标题
            SafeArea(
              child: Align(
            ...
            AnimatedBuilder(
              ...
              builder: (context, child) {
                ...
                final Alignment islandAlignment =
                    aspectRatio > 0.6 ? const Alignment(0, -0.16) : const Alignment(0, -0.4);
                return Align(
                  alignment: islandAlignment,
                  child: Transform.translate(offset: Offset(0, _floatAnimation.value), child: child),
                );
              },
              child: Stack(
                ...
                children: [
                  ...
                  ImageFiltered(
                    ...
                    child: Image.asset(
                      islandPath,
                      width: (screenWidth <= 600 ? screenWidth * 0.9 : 540.0) * 1.05,
                      fit: BoxFit.contain,
                      color: _getIslandGlowColorForCurrentTime(),
                    ),
                  ),
                  ...
                  ShaderMask(
                    ...
                    child: Image.asset(
                      islandPath,
                      width: screenWidth <= 600 ? screenWidth * 0.9 : 540.0,
                      fit: BoxFit.contain,
                    ),
                  ),
                ],
